...
from booking_shared_models.schemas import UserCreate, User as UserSchema
...
async def register_user(
    ...
    existing_username = await user_repository.get_by_username(session, user_data.username)
    ...
    async with transaction(session):
        user = await user_repository.create(session, {
